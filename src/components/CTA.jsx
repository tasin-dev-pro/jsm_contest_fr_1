...
const CTA = () => {
  ...
  <div className="container px-10 py-24 mx-auto flex sm:flex-nowrap flex-wrap items-center">
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <p className="leading-relaxed mb-5 text-gray-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, nesciunt.</p>
      ...
      <p className="text-xs text-gray-500 mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, dolore!</p>
    </div>
  </div>
</section>
  )
